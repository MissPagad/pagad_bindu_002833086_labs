...
public class BrowseProductsJPanel extends javax.swing.JPanel {
  ...
  Order currentOrder;
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Please check the modified quntatity field.");
        return;
    }
    ...
    private void btnViewOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewOrderItemActionPerformed
        ...
        OrderItem item = (OrderItem) tblCart.getValueAt(selectedRowIndex, 0);
        ViewOrderItemDetailJPanel vieworderPanel = new ViewOrderItemDetailJPanel(userProcessContainer, item);
        userProcessContainer.add("ViewOrderItemDetailJPanel", vieworderPanel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Please check price and quntatity fields.");
        return;
    }
    ...
    private void populateProductTable(String productNamne) {
        ...
        for (Supplier s : supplierDirectory.getSupplierlist()) {
            for (Product p : s.getProductCatalog().getProductcatalog()) {
                ...
                if (p.getProdName().equalsIgnoreCase(productNamne)) {
                    Object row[] = new Object[4];
                    row[0] = p;
                    row[1] = p.getModelNumber();
                    row[2] = p.getPrice();
