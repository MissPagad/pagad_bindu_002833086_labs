...
//        layout.previous(workArea);
        ...
        for (Component component : componentArray) {
            if (component instanceof ManageProductCatalogJPanel) {
                manageProductCatalogJPanel = (ManageProductCatalogJPanel) component;
                break; // Stop searching once we find the correct panel
            }
        }
        ...
        if (manageProductCatalogJPanel != null) {
            manageProductCatalogJPanel.refreshTable();
            CardLayout layout = (CardLayout) workArea.getLayout();
            layout.previous(workArea);// Call the refreshTable() method
        } else {
            // Handle the case where ManageProductCatalogJPanel is not found
        }
    }
