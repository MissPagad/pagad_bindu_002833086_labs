...
import model.ImageTableCellRenderer;
...
public class ManageProductCatalogJPanel extends javax.swing.JPanel {
    ...
    public ManageProductCatalogJPanel(JPanel workArea, Supplier supplier) {
        ...
        if (supplier.getLogoImage() != null) {
            logoIcon = supplier.getLogoImage();
        }

        if (logoIcon != null) {
            imgLogo.setIcon(logoIcon);
        } else {
    ...
    public void refreshTable() {
        ...
        tblProducts.getColumnModel().getColumn(3).setCellRenderer(new ImageTableCellRenderer(desiredImageSize));
    ...
    private void initComponents() {
        ...
        tblProducts.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product Name", "Product ID", "Price", "Product Icon"
            }
        ));
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        if (row < 0) {
            JOptionPane.showConfirmDialog(null, "Please select a row from the tabel first", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        workArea.add("ViewProductDetailJPanel", viewProduct);
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        workArea.add("SearchProductJPanel", searchProduct);
        CardLayout layout = (CardLayout) workArea.getLayout();
        layout.next(workArea);
